...
const responsesFile = process.env.ORBIT_JOB_WORK_TIME_RESPONSES_FILE
const requestLog = process.env.ORBIT_JOB_WORK_TIME_REQUEST_LOG
if (!responsesFile || !requestLog) throw new Error('The work-time transport needs private response/log files')
