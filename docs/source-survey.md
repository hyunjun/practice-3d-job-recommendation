...
이 단계에서 검증한 공식 게시판 **47곳**을 추가해 기본 수집 대상은 **83곳**입니다. Greenhouse 50개, Ashby 24개, Lever 4개, SmartRecruiters 5개입니다. 샘플의 32개 회사·179개 공고·22개 도시는 별도로 유지합니다.
...
| [Microsoft](https://careers.microsoft.com/v2/global/en/home.html) | 200 | 공식 Eightfold 기반 채용 경로 확인. 현행 전체 목록 수집 규약은 미확정 |
...
| [Adobe](https://careers.adobe.com/us/en) | 200 | 공식 채용 페이지 확인. 자체 또는 별도 채용 시스템의 전체 목록·본문 수집 규약은 미확정 |
| [Salesforce](https://www.salesforce.com/company/careers/) | 200 | 공식 채용 페이지 확인. 자체 또는 별도 채용 시스템의 전체 목록·본문 수집 규약은 미확정 |
...
| [Cisco](https://careers.cisco.com/global/en) | 200 | 공식 채용 페이지 확인. 자체 또는 별도 채용 시스템의 전체 목록·본문 수집 규약은 미확정 |
| [Intel](https://intel.wd1.myworkdayjobs.com/External/page/6042070b79e01001f04fa9b468070000) | 200 | 공식 Workday 채용 경로 확인. 현재 수집기가 지원하는 네 공개 API와 다른 규약 |
| [AMD](https://careers.amd.com/careers-home/jobs) | 200 | 공식 iCIMS 채용 경로 확인. 현행 전체 목록 수집 규약은 미확정 |
| [Qualcomm](https://careers.qualcomm.com/careers) | 200 | 공식 Eightfold 기반 채용 경로 확인. 현행 전체 목록 수집 규약은 미확정 |
| [Broadcom](https://www.broadcom.com/company/careers) | 200 | 공식 채용 페이지 확인. 자체 또는 별도 채용 시스템의 전체 목록·본문 수집 규약은 미확정 |
...
| [Workday](https://www.workday.com/en-us/company/careers/overview.html) | 200 | 공식 Workday 채용 경로 확인. 현재 수집기가 지원하는 네 공개 API와 다른 규약 |
...
| [Red Hat](https://www.redhat.com/en/jobs) | 200 | 공식 Workday 채용 경로 확인. 현재 수집기가 지원하는 네 공개 API와 다른 규약 |
...
| [Samsung](https://www.samsung.com/us/careers/) | 200 | 공식 Workday 채용 경로 확인. 현재 수집기가 지원하는 네 공개 API와 다른 규약 |
...
| [Hugging Face](https://huggingface.co/JOIN-US) | 200 | 공식 페이지에서 Workable 게시판 확인. 현재 네 제공자의 수집기와 다른 규약 |
...
| [SmartNews](https://careers.smartnews.com/en/) | 200 | 공식 페이지에서 Workable 게시판 확인. 현재 네 제공자의 수집기와 다른 규약 |
| [Mercari](https://careers.mercari.com/) | 200 | 공식 채용 페이지 확인. 자체 또는 별도 채용 시스템의 전체 목록·본문 수집 규약은 미확정 |
...
|---|---|---|
| [Himalayas](https://himalayas.app/docs/remote-jobs-api) | 인증 없는 조회 API, 회사 슬러그 필터·전체 페이지 조회, API 데이터의 출처 표시와 보이는 역링크 요구 | 회사별 보충 수집 후보. 사이트 HTML의 일반 약관과 별도로 API 전용 문서의 사용 허용 범위를 확인 |
...
여러 잡 사이트의 재게시물을 단순 합산하면 같은 포지션을 중복 집계하거나 회사 전체 채용을 과장할 수 있습니다. 현재 추가분은 공식 게시판 출처이며 위 잡 사이트에서 수집한 자료라고 표시하지 않습니다. LinkedIn의 직접 자동 수집은 별도 조사에서 확인한 접근 조건 때문에 포함하지 않았습니다.
