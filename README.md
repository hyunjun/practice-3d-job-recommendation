...
처음에는 **샘플 데이터와 샘플 프로필**로 시작합니다. 상단의 **샘플 탐색 → 공개 채용공고**를 선택하면 실제 Greenhouse·Ashby·Lever·SmartRecruiters 게시판을 함께 조회합니다. 공개 채용 조회에는 인터넷이 필요하며, 첫 조회에는 1분 이상 걸릴 수 있습니다.
